...
_ProofOfDeliveryModel _$ProofOfDeliveryModelFromJson(
...
Map<String, dynamic> _$ProofOfDeliveryModelToJson(
        _ProofOfDeliveryModel instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_UploadProofRequest _$UploadProofRequestFromJson(Map<String, dynamic> json) =>
    _UploadProofRequest(
      deliveryId: json['delivery_id'] as String,
      delivererId: json['deliverer_id'] as String,
      customerId: json['customer_id'] as String,
      ...
      longitude: (json['longitude'] as num).toDouble(),
      signatoryName: json['signatory_name'] as String,
      signatureImageBase64: json['signature_image'] as String,
      photosBase64:
...
Map<String, dynamic> _$UploadProofRequestToJson(_UploadProofRequest instance) =>
    <String, dynamic>{
      'delivery_id': instance.deliveryId,
      'deliverer_id': instance.delivererId,
      'customer_id': instance.customerId,
      ...
      'longitude': instance.longitude,
      'signatory_name': instance.signatoryName,
      'signature_image': instance.signatureImageBase64,
      'photos': instance.photosBase64,
      'notes': instance.notes,
      'customer_feedback': instance.customerFeedback,
    };

_UploadProofResponse _$UploadProofResponseFromJson(Map<String, dynamic> json) =>
    _UploadProofResponse(
      ...
      photosUrls: (json['photos_urls'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
    );

Map<String, dynamic> _$UploadProofResponseToJson(
        _UploadProofResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
