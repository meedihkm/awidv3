...
_$CustomerOrderItemModelImpl _$$CustomerOrderItemModelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CustomerOrderItemModelImplToJson(
        _$CustomerOrderItemModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
