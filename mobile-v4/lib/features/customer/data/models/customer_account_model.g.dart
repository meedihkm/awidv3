...
_CustomerAccountModel _$CustomerAccountModelFromJson(
...
Map<String, dynamic> _$CustomerAccountModelToJson(
        _CustomerAccountModel instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_CustomerCreditInfoModel _$CustomerCreditInfoModelFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CustomerCreditInfoModelToJson(
        _CustomerCreditInfoModel instance) =>
    <String, dynamic>{
...
_CustomerPackagingInfoModel _$CustomerPackagingInfoModelFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CustomerPackagingInfoModelToJson(
        _CustomerPackagingInfoModel instance) =>
    <String, dynamic>{
...
_CustomerPackagingItemModel _$CustomerPackagingItemModelFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CustomerPackagingItemModelToJson(
        _CustomerPackagingItemModel instance) =>
    <String, dynamic>{
...
_CustomerStatsModel _$CustomerStatsModelFromJson(Map<String, dynamic> json) =>
    _CustomerStatsModel(
...
Map<String, dynamic> _$CustomerStatsModelToJson(_CustomerStatsModel instance) =>
    <String, dynamic>{
...
_CustomerContactModel _$CustomerContactModelFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CustomerContactModelToJson(
        _CustomerContactModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'role': instance.role,
...
_CustomerSettingsModel _$CustomerSettingsModelFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CustomerSettingsModelToJson(
        _CustomerSettingsModel instance) =>
    <String, dynamic>{
