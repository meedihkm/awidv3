...
mixin _$CustomerOrder {
  ...
  List<CustomerOrderItem> get items => throw _privateConstructorUsedError;
...
abstract class _CustomerOrder implements CustomerOrder {
  const factory _CustomerOrder(
      ...
      final String? proofOfDeliveryId,
      final DateTime? createdAt,
      final DateTime? updatedAt}) = _$CustomerOrderImpl;
...
CustomerOrderItem _$CustomerOrderItemFromJson(Map<String, dynamic> json) {
  return _CustomerOrderItem.fromJson(json);
}
...
/// @nodoc
abstract class $CustomerOrderItemCopyWith<$Res> {
  factory $CustomerOrderItemCopyWith(
          CustomerOrderItem value, $Res Function(CustomerOrderItem) then) =
      _$CustomerOrderItemCopyWithImpl<$Res, CustomerOrderItem>;
  @useResult
  $Res call(
      {String id,
      String productId,
...
/// @nodoc
class _$CustomerOrderItemCopyWithImpl<$Res, $Val extends CustomerOrderItem>
    implements $CustomerOrderItemCopyWith<$Res> {
  _$CustomerOrderItemCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CustomerOrderItemImplCopyWith<$Res>
    implements $CustomerOrderItemCopyWith<$Res> {
  factory _$$CustomerOrderItemImplCopyWith(_$CustomerOrderItemImpl value,
          $Res Function(_$CustomerOrderItemImpl) then) =
      __$$CustomerOrderItemImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$CustomerOrderItemImplCopyWithImpl<$Res>
    extends _$CustomerOrderItemCopyWithImpl<$Res, _$CustomerOrderItemImpl>
    implements _$$CustomerOrderItemImplCopyWith<$Res> {
  __$$CustomerOrderItemImplCopyWithImpl(_$CustomerOrderItemImpl _value,
      $Res Function(_$CustomerOrderItemImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CustomerOrderItemImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$CustomerOrderItemImpl implements _CustomerOrderItem {
  const _$CustomerOrderItemImpl(
      {required this.id,
  ...
  factory _$CustomerOrderItemImpl.fromJson(Map<String, dynamic> json) =>
      _$$CustomerOrderItemImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CustomerOrderItemImpl &&
            (identical(other.id, id) || other.id == id) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CustomerOrderItemImplCopyWith<_$CustomerOrderItemImpl> get copyWith =>
      __$$CustomerOrderItemImplCopyWithImpl<_$CustomerOrderItemImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CustomerOrderItemImplToJson(
      this,
    );
  }
}

abstract class _CustomerOrderItem implements CustomerOrderItem {
  const factory _CustomerOrderItem(
      {required final String id,
      ...
      final String? productImage,
      final String? unit,
      final String? notes}) = _$CustomerOrderItemImpl;

  factory _CustomerOrderItem.fromJson(Map<String, dynamic> json) =
      _$CustomerOrderItemImpl.fromJson;
