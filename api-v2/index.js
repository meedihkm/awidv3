...
<body>
    ...
    <script>
        ...
        async function toggleOrg(id, active) { await fetch(API + '/super-admin/organizations/' + id + '/status', { method: 'PATCH', headers: getHeaders(), body: JSON.stringify({ active }) }); loadOrgs(); loadStats(); }
